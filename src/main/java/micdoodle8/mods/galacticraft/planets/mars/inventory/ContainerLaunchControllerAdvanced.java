...
public class ContainerLaunchControllerAdvanced extends Container {
    private final TileEntityLaunchController tileEntity;

    public ContainerLaunchControllerAdvanced(InventoryPlayer par1InventoryPlayer, TileEntityLaunchController tileEntity, EntityPlayer player) {
